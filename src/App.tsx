  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-2">
          <Indicator
            totalParticipatingCountries={totalParticipatingCountries}
            indicatorTitle="Pays participants"
            baseColor="blue"
          />
          <Indicator
            totalParticipatingCountries={totalGamesEditions}
            indicatorTitle="Éditions des JO"
            baseColor="green"
          />
        </div>
